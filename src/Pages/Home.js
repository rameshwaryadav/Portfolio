                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Rameshwar</b>
                          <b className="is-hidden">yadav</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/rameshwaryadav0"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/rameshwaryadav"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/r_yadav__62/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".8s">
                            <a
                              href="https://twitter.com/r_yadav__62"
                              target="newtab"
                            >
                              <i
...
BCA is an undergraduate program emphasizing computer science.
 Students learn programming, databases,
 software development, and networking,
preparing for IT careers or advanced studies.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hello!I'm Rameshwar Yadav </h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a web developer from janjgir-chapma chhattisgarh, India.{" "}
              ...
              <div className="row love-row wow fadeIn">
                <div className="col-md-6">
                  <div className="skill-details text-left">
                    <p>
                    I possess proficiency in C/C++, HTML, CSS, JavaScript, Python, and MySQL, 
                      enabling me to develop versatile and robust software applications. My skills encompass both front-end and back-end development,
                     database management, and efficient problem-solving.(helping you get
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my School life from PVT.MUSKAN H.S.S.Jewara, Chhattisgarh,495554, India.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Bachelor in Computer Application from{" "}
                          <a
                            href="https://chaitanyacg.ac.in/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                           Chaitanya Science & Arts College Pamgarh Dist -Janjgir-Champa,Chhattisgarh,495554
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            ...
                            rel="noopener noreferrer"
                          >
                            business impact analysis (BIA) - TechTarget
                          </a>
                          , Bengaluru, India.
                        </p>
                      </div>
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".2s">
                        ...
                        ></i>
                        <h3>Address</h3>
                        <p>Jewara-pamgarh,chhattisgarh,495554, India</p>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        >
                          contact.0rameshawaryadav@gmail.com
                        </a>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 contact-colamn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        ></i>
                        <h3>Portfolio</h3>
                        <p>https://github.com/rameshwaryadav/</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="hhttps://www.bing.com/maps?q=jewara+pamgarh&FORM=HDRSC6&cp=21.852119%7E82.371583&lvl=16.0ttps://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d471220.5630603985!2d88.0495328251319!3d22.675752087592436!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f882db4908f667%3A0x43e330e68f6c2cbc!2sKolkata%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1653845709428!5m2!1sen!2sin"
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
